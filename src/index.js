...
<Card style={{ width: "21rem" }}>
            ...
            <Card.Body>
              ...
              <div class="icons">
                <div class="ios">
                <a href="https://snack.expo.dev/?platform=ios" target="_blank"><i class="fa fa-apple" aria-hidden="true"></i></a>
                <a href="https://snack.expo.dev/?platform=ios" target="_blank">iOS App</a>
</div>
<div class="android">
                <a href="https://snack.expo.dev/?platform=android" target="_blank"><i class="fa fa-android" aria-hidden="true"></i></a>
                <a href="https://snack.expo.dev/?platform=android" target="_blank">Android App</a>
</div>
                </div>
            </Card.Body>
          </Card>
